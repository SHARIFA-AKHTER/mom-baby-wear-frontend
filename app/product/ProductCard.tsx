...
import { Button } from "@/components/ui/button";
import { useRouter } from "next/navigation"; 
import { Heart, Loader2, Percent } from "lucide-react"; 
import { useWishlist } from "@/app/hooks/useWishlist"; 
...
export default function ProductCard({ product }: Props) {
  ...
  return (
    <div className="group rounded-xl border bg-white shadow-sm hover:shadow-lg transition flex flex-col overflow-hidden relative">
      ...
      {hasOffer && (
        <div className="absolute top-3 left-3 z-10 bg-pink-600 text-white text-[10px] font-bold px-2 py-1 rounded-full flex items-center gap-1 shadow-md">
